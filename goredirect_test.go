			...
			Mappings: []Mapping{
				{
					...
					SrcHostname:            "",
					SrcToDstRepoPathMapper: MustGetNewStringMapper("", "/path-to-my-repo/on-github"),
				},
			},
			DefaultHandler: nil,
			InnerCases: []innerCase{
			...
			Mappings: []Mapping{
				{
					...
					SrcToDstRepoPathMapper: MustGetNewStringMapper("/customPath", "/path/to/custom"),
				},
				{
					DstVCS:                 "git",
					DstScheme:              "https",
					DstHostname:            "github.com",
					SrcHostname:            "",
					SrcToDstRepoPathMapper: MustGetNewStringMapper("/repo(?P<repo>.+)/user(?P<owner>.+)", "/{{.owner}}/{{.repo}}"),
				},
				{
					DstVCS:                 "hg",
					DstScheme:              "https",
					...
					SrcHostname:            "",
					SrcToDstRepoPathMapper: MustGetNewStringMapper("/hg/(?P<owner>.+)/(?P<repo>.+)", "/{{.owner}}/{{.repo}}"),
				},
				{
					DstVCS:                 "git",
					DstScheme:              "https",
					DstHostname:            "github.com",
					SrcHostname:            "",
					SrcToDstRepoPathMapper: MustGetNewStringMapper("/(?P<owner>.+)/(?P<repo>.+)\\.git", "/{{.owner}}/{{.repo}}"),
				},
				{
					DstVCS:                 "git",
					DstScheme:              "https",
					DstHostname:            "github.com",
					SrcHostname:            "",
					SrcToDstRepoPathMapper: MustGetNewStringMapper("/(?P<owner>.+)/(?P<repo>.+)", "/{{.owner}}/{{.repo}}"),
				},
			},
			DefaultHandler: nil,
			InnerCases: []innerCase{
